...
// serve text/markdown to agents that ask for it, keep text/html for browsers,
// always advertise `Vary: Accept`, and return 406 when nothing matches.
...
function hasStaticExtension(pathname: string): boolean {
  ...
  return dot > 0 && last.slice(dot + 1).toLowerCase() !== "md";
}
